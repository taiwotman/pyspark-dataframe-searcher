...
The objective is to search the _*col 2-4*_ of the pyspark dataframe for values in _*col1*_ and to return the _*id row-name(s), column-name(s)*_. The expected solution are the following:
